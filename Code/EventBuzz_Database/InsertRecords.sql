...
-- Insert data into Notifications_SendTo_Users table
INSERT INTO Notifications_SendTo_Users (user_id, notification_id)
VALUES (1, 1);

-- Insert data into Users_RegisterFor_Events table
INSERT INTO Users_RegisterFor_Events (user_id, event_name, registration_date)
VALUES (1, 'Spring Music Fest', NOW());

-- Insert data into Events_FundedBy_Sponsors table
INSERT INTO Events_FundedBy_Sponsors (event_name, sponsor_name, sponsorship_amount, sponsorship_date)
VALUES ('Spring Music Fest', 'Sponsor Inc', 5000.00, NOW());

-- Insert data into Events_OrganisedBy_Organisers table
INSERT INTO Events_OrganisedBy_Organisers (event_name, organiser_name, organiser_role)
...
SELECT * FROM Notifications_SendTo_Users;
SELECT * FROM Users_RegisterFor_Events;
SELECT * FROM Events_FundedBy_Sponsors;
SELECT * FROM Events_OrganisedBy_Organisers;
...
DELETE FROM Notifications_SendTo_Users;
DELETE FROM Users_RegisterFor_Events;
DELETE FROM Events_FundedBy_Sponsors;
DELETE FROM Events_OrganisedBy_Organisers;
...
-- Drop all tables
DROP TABLE IF EXISTS Notifications_SendTo_Users;
DROP TABLE IF EXISTS Users_RegisterFor_Events;
DROP TABLE IF EXISTS Events_FundedBy_Sponsors;
DROP TABLE IF EXISTS Events_OrganisedBy_Organisers;
